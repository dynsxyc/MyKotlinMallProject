...
import com.zhongjiang.hotel.base.ext.editEnable
import com.zhongjiang.hotel.base.ext.setVisible
import com.zhongjiang.hotel.base.ext.shieldDoubleClick
import com.zhongjiang.hotel.base.ui.fragment.BaseMvpFragment
import com.zhongjiang.hotel.base.utils.FormatPhoneTextWatcher
...
class LoginFragment : BaseMvpFragment<LoginFragmentPresenter>(), LoginFragmentContract.View {
    ...
    fun initSubView() {
        mLoginFragmentEtPhone.addTextChangedListener(FormatPhoneTextWatcher(mLoginFragmentEtPhone) { checkLoginEnable() })
