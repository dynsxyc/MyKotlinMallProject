...
import com.zhongjiang.hotel.base.imageloader.YXImageView
import com.zhongjiang.hotel.base.oss.UpFileBean
import com.zhongjiang.hotel.base.ui.fragment.BaseSelectorImgFragment
...
class TestPictureFragment : BaseSelectorImgFragment<TestFragmentPresenter>(), TestFragmentContract.View {
    ...
    override fun onFileUpIng(upFileBean: UpFileBean) {
        ULogger.i("文件名 = ${upFileBean.fileName},上传状态= ${upFileBean.upType},上传进度= ${upFileBean.progress},图片路径 = ${upFileBean.filePath},上传返回路径=${upFileBean.upSuccessUrl}")
    }
