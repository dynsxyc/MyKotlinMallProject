 ...
 */
open class BaseFragment : RxFragment(), AnkoLogger ,ISupportFragment,ISwipeBackFragment{
    val mDelegate : SupportFragmentDelegate = SupportFragmentDelegate(this)
    val mSwipeBackDelegate : SwipeBackFragmentDelegate = SwipeBackFragmentDelegate(this)
