...
import com.zhongjiang.kotlin.base.common.PictureSelectorConfig
...
abstract class BaseSelectorImgFragment<P : BasePresenter<V, M>, V : IView, M : IModel> : BaseMvpFragment<P>() {
    ...
    protected fun openMedia(isCamera: Boolean) {
        ...
        pictureselectionmodel.theme(com.zhongjiang.kotlin.base.R.style.picture_default_style)//主题样式(不设置为默认样式) 也可参考demo values/styles下 例如：R.style.picture.white.style
