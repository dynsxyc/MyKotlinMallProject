...
import com.zhongjiang.hotel.base.data.net.service.GlobalServiceManager
...
abstract class BaseModel<S : BaseServiceManager>  : IModel {
    ...
    @Inject
    lateinit var schedulers: com.zhongjiang.hotel.base.injection.module.sheduler.SchedulerProvider
