...
constructor(context: Context,
    ...
    init {
        ...
        val loadingViewResId = a.getResourceId(R.styleable.MultiStateView_msv_loadingView, R.layout.layout_state_loading)
        ...
        val emptyViewResId = a.getResourceId(R.styleable.MultiStateView_msv_emptyView, R.layout.layout_state_empty)
        if (emptyViewResId > -1) {
            try {
        ...
        val errorViewResId = a.getResourceId(R.styleable.MultiStateView_msv_errorView, R.layout.layout_state_error)
        if (errorViewResId > -1) {
            try {
                ...
                val retryBt = inflatedErrorView.findViewById<Button>(R.id.retry)
                retryBt?.let {
        ...
        animateLayoutChanges = a.getBoolean(R.styleable.MultiStateView_msv_animateViewChanges, true)
        a.recycle()
    }
