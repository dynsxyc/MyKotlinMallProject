package com.zhongjiang.dyn.imageselector;
...
import com.zhongjiang.dyn.imageselector.model.ImageModel;
import com.zhongjiang.dyn.imageselector.utils.DateUtils;
...
import static com.zhongjiang.dyn.imageselector.model.ImageModel.EXTRA_SHOW_GIF;
...
//        });
        ...
        mediaStoreArgs.putBoolean(EXTRA_SHOW_GIF, false);
        ImageModel.getPhotoDirs(this, mediaStoreArgs, new ImageModel.DataCallback() {
            @Override
